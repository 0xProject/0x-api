...
import { Integrator } from '../../src/asset-swapper/types';
...
function toRfqClientV1Price(order: SignedNativeOrder): RfqClientV1Price {
    return {
...
describe('MarketOperationUtils tests', () => {
    ...
    function getMockedQuoteRequestor(
        ...
        requestor.setup((r) => r.setMakerUriForSignature(TypeMoq.It.isAny(), TypeMoq.It.isAny())).returns(() => {});
        if (type === 'firm') {
            requestor

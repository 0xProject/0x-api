...
| `INFURA_API_KEY`                             | Required. No default.                                           | This is the project's Infura key and is required for web3 calls on Ethereum, Goerli networks. |
| `ALCHEMY_POLYGON_API_KEY`                             | Required. No default.                                           | This is the project's Alchemy API key on Polygon networks and is required for web3 calls. |
| `ALCHEMY_MUMBAI_API_KEY`                             | Required. No default.                                           | This is the project's Alchemy API key on Mumbai networks and is required for web3 calls. |
...
| `DATABASE_USER_NAME`                         | Required. Default : `api` | The database user name to connect to the PostgreSQL database.                                       |
| `DATABASE_USER_PASSWORD`                         | Required. Default : `api` | The database user password to connect to the PostgreSQL database.                                       |
| `DATABASE_NAME`                         | Required. Default : `api` | The database name to connect to the PostgreSQL database.                                       |

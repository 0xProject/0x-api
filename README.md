...
| `LOG_LEVEL`                            | Default: `info`                                                 | The log level for `pino.js`.                                                                                                                                                                              |
| `LOG_ASYNC_ENABLED`                    | Default: `false`                                                | A boolean determining whether or not to enable async logging.                                                                                                                                             |
| `LOG_BUFFER_BYTES`                     | Default: `4096`                                                 | The log write buffer size.                                                                                                                                                                                |
| `LOG_ASYNC_FLUSH_INTERVAL_SEC`         | Default: `10`                                                   | The log flush interval in seconds when `LOG_ASYNC_ENABLED` is set to true.                                                                                                                                |

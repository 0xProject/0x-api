...
export interface Quote {
  ...
  inputAmount: BigNumberJs;
  outputTokenAddress: string;
  outputAmount: BigNumberJs;
  price: BigNumberJs;
  estimatedPriceImpact?: BigNumberJs | null | undefined;
  inputTokenToNativeRate: BigNumberJs;
  outputTokenToNativeRate: BigNumberJs;
  chainId: number;
  gas: BigNumberJs;
...
export interface GetQuoteRequest {
  inputTokenAddress: string;
  outputTokenAddress: string;
  inputAmount?: BigNumberJs | null | undefined;
  outputAmount?: BigNumberJs | null | undefined;
  chainId: number;
  takerAddress: string;
  integratorId: string;
...
export const Quote = {
  ...
  initialize: function (): Quote {
    return {
      inputTokenAddress: "",
      inputAmount: BigNumberJs.initialize(),
      outputTokenAddress: "",
      outputAmount: BigNumberJs.initialize(),
      price: BigNumberJs.initialize(),
      estimatedPriceImpact: undefined,
      inputTokenToNativeRate: BigNumberJs.initialize(),
      outputTokenToNativeRate: BigNumberJs.initialize(),
      chainId: 0,
  ...
  _writeMessage: function (
    ...
    if (msg.inputTokenAddress) {
      writer.writeString(1, msg.inputTokenAddress);
    }
    if (msg.inputAmount) {
      writer.writeMessage(2, msg.inputAmount, BigNumberJs._writeMessage);
    }
    if (msg.outputTokenAddress) {
      writer.writeString(3, msg.outputTokenAddress);
    }
    if (msg.outputAmount) {
      writer.writeMessage(4, msg.outputAmount, BigNumberJs._writeMessage);
    }
    if (msg.price) {
    ...
    if (msg.inputTokenToNativeRate) {
      writer.writeMessage(
        7,
        msg.inputTokenToNativeRate,
        BigNumberJs._writeMessage
      );
    }
    if (msg.outputTokenToNativeRate) {
      writer.writeMessage(
        8,
        msg.outputTokenToNativeRate,
        BigNumberJs._writeMessage
      );
    }
    if (msg.chainId) {
  ...
  _readMessage: function (msg: Quote, reader: BinaryReader): Quote {
    while (reader.nextField()) {
      ...
      switch (field) {
        case 1: {
          msg.inputTokenAddress = reader.readString();
          break;
        }
        case 2: {
          reader.readMessage(msg.inputAmount, BigNumberJs._readMessage);
          break;
        }
        case 3: {
          msg.outputTokenAddress = reader.readString();
          break;
        }
        case 4: {
          reader.readMessage(msg.outputAmount, BigNumberJs._readMessage);
          break;
        }
        case 5: {
...
export const GetQuoteRequest = {
  ...
  _writeMessage: function (
    ...
    if (msg.outputTokenAddress) {
      writer.writeString(2, msg.outputTokenAddress);
    }
    if (msg.inputAmount != undefined) {
      writer.writeMessage(3, msg.inputAmount, BigNumberJs._writeMessage);
    }
    if (msg.outputAmount != undefined) {
      writer.writeMessage(4, msg.outputAmount, BigNumberJs._writeMessage);
    }
    if (msg.chainId) {
  ...
  _readMessage: function (
    ...
    while (reader.nextField()) {
      ...
      switch (field) {
        ...
        case 3: {
          msg.inputAmount = BigNumberJs.initialize();
          reader.readMessage(msg.inputAmount, BigNumberJs._readMessage);
          break;
        }
        case 4: {
          msg.outputAmount = BigNumberJs.initialize();
          reader.readMessage(msg.outputAmount, BigNumberJs._readMessage);
          break;
        }
        case 5: {
...
export const QuoteJSON = {
  ...
  _writeMessage: function (msg: Partial<Quote>): Record<string, unknown> {
    const json: Record<string, unknown> = {};
    if (msg.inputTokenAddress) {
      json["inputTokenAddress"] = msg.inputTokenAddress;
    }
    if (msg.inputAmount) {
      const inputAmount = BigNumberJsJSON._writeMessage(msg.inputAmount);
      if (Object.keys(inputAmount).length > 0) {
        json["inputAmount"] = inputAmount;
      }
    }
    if (msg.outputTokenAddress) {
      json["outputTokenAddress"] = msg.outputTokenAddress;
    }
    if (msg.outputAmount) {
      const outputAmount = BigNumberJsJSON._writeMessage(msg.outputAmount);
      if (Object.keys(outputAmount).length > 0) {
        json["outputAmount"] = outputAmount;
      }
    }
    if (msg.price) {
    ...
    if (msg.inputTokenToNativeRate) {
      const inputTokenToNativeRate = BigNumberJsJSON._writeMessage(
        msg.inputTokenToNativeRate
      );
      if (Object.keys(inputTokenToNativeRate).length > 0) {
        json["inputTokenToNativeRate"] = inputTokenToNativeRate;
      }
    }
    if (msg.outputTokenToNativeRate) {
      const outputTokenToNativeRate = BigNumberJsJSON._writeMessage(
        msg.outputTokenToNativeRate
      );
      if (Object.keys(outputTokenToNativeRate).length > 0) {
        json["outputTokenToNativeRate"] = outputTokenToNativeRate;
      }
    }
    if (msg.chainId) {
  ...
  _readMessage: function (msg: Quote, json: any): Quote {
    const _inputTokenAddress =
      json["inputTokenAddress"] ?? json["input_token_address"];
    if (_inputTokenAddress) {
      msg.inputTokenAddress = _inputTokenAddress;
    }
    const _inputAmount = json["inputAmount"] ?? json["input_amount"];
    if (_inputAmount) {
      const m = BigNumberJs.initialize();
      BigNumberJsJSON._readMessage(m, _inputAmount);
      msg.inputAmount = m;
    }
    const _outputTokenAddress =
      json["outputTokenAddress"] ?? json["output_token_address"];
    if (_outputTokenAddress) {
      msg.outputTokenAddress = _outputTokenAddress;
    }
    const _outputAmount = json["outputAmount"] ?? json["output_amount"];
    if (_outputAmount) {
      const m = BigNumberJs.initialize();
      BigNumberJsJSON._readMessage(m, _outputAmount);
      msg.outputAmount = m;
    }
    ...
    const _inputTokenToNativeRate =
      json["inputTokenToNativeRate"] ?? json["input_token_to_native_rate"];
    if (_inputTokenToNativeRate) {
      const m = BigNumberJs.initialize();
      BigNumberJsJSON._readMessage(m, _inputTokenToNativeRate);
      msg.inputTokenToNativeRate = m;
    }
    const _outputTokenToNativeRate =
      json["outputTokenToNativeRate"] ?? json["output_token_to_native_rate"];
    if (_outputTokenToNativeRate) {
      const m = BigNumberJs.initialize();
      BigNumberJsJSON._readMessage(m, _outputTokenToNativeRate);
      msg.outputTokenToNativeRate = m;
    }

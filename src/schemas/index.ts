...
import * as slippageModelDataFileSchema from './slippage_model_data_file_schema.json';
import * as slippageModelDataSchema from './slippage_model_data_schema.json';
...
export const schemas = {
    ...
    slippageModelDataFileSchema,
    slippageModelDataSchema,

...
export class BasicSwapHandlers {
    ...
    constructor(swapService: SwapService, basicSwapService: BasicSwapService) {
        this._swapService = swapService;
        this._basicSwapService = basicSwapService;
    }
    ...
    private async _getSwapQuoteAsync(params: GetSwapQuoteParams): Promise<GetSwapQuoteResponse> {
        try {
            ...
            if (params.isUnwrap) {
                ...
                swapQuote = await this._basicSwapService.getQuoteAsync(params);
            }

# Step 1 - Create an unsigned order

## Request

```
GET api.0x.org/order_wizard/construct/step1?
    myAddress=0x5496e6ac4574da8b3481bbcf3b8f6c3a52afab15&
    buy=DAI&
    sell=USDC&
    amount_buy=1000&
    amount_sell=1000
...
```json
{
    "help": "Please sign the '.toSign.payload' field (ex. ec_sign(payload, private_key)), and replace the '.toSign.signatureOutput' with the hex-encoded signature",
    "payload" : {
        "order" : {
...
```json
POST api.0x.org/order_wizard/construct/step2

{
    ...
    "toSign": {
        "variableName": "signatureHexOfOrderHash",
        "payload": "0x568377ab709f258efaa3b6d8a1da2310e4835f53cdb9700edcc7112e97a7fdc3",
        "signatureOutput": "0xo18792847y892yo87yo2387y4296734972y387h8h283g423g48723g23uyg4iuy2b3u4"
    }
}
```

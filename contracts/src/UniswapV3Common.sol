...
contract UniswapV3Common {
    ...
    uint256 internal constant QUOTE_GAS = 700e3;
    ...
    function _getTopTwoPools(
        ...
        uint256 inputAmount
    ) internal returns (IUniswapV3Pool[2] memory topPools, uint256[2] memory outputAmounts) {
    ...
    function _isValidPool(IUniswapV3Pool pool) internal view returns (bool isValid) {

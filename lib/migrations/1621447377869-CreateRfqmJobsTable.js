...
exports.CreateRfqmJobsTable1621447377869 = void 0;
const typeorm_1 = require("typeorm");
const rfqmJobsTable = new typeorm_1.Table({
    name: 'rfqm_jobs',
    columns: [
...
const createdAtIndex = new typeorm_1.TableIndex({ name: `rfqm_jobs_created_at_index`, columnNames: ['created_at'] });
const statusIndex = new typeorm_1.TableIndex({ name: `rfqm_jobs_status_index`, columnNames: ['status'] });
class CreateRfqmJobsTable1621447377869 {
...
exports.CreateRfqmJobsTable1621447377869 = CreateRfqmJobsTable1621447377869;
//# sourceMappingURL=1621447377869-CreateRfqmJobsTable.js.map